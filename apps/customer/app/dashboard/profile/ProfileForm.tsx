  ...
  return (
    <form onSubmit={handleSubmit} className="divide-y divide-gray-100">
      ...
      <Toggle 
        ...
        description="Receive booking confirmations, OTPs, and receipts via email." 
      ...
      <Toggle 
        name="sms" 
        label="SMS Alerts" 
        description="Get text messages for urgent updates and OTP delivery." 
      ...
      <Toggle 
        ...
        description="Receive rich updates and location directions directly on WhatsApp." 
      ...
      <Toggle 
        ...
        description="Get native mobile/browser push notifications when the app is closed." 
