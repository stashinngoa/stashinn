    ...
    <div className="min-h-screen bg-gray-50 flex font-inter">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center px-4 md:px-8 shrink-0">
          <button 
            className="md:hidden mr-4 p-2 -ml-2 text-gray-500 hover:text-gray-900 hover:bg-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 shrink-0"
