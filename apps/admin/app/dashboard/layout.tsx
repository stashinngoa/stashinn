...
export default async function AdminDashboardLayout({
    ...
    <div className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col h-full shrink-0">
      ...
      <nav className="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
        <Link href="/dashboard" className="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
          <svg className="mr-3 h-5 w-5 text-gray-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Link href="/dashboard/reviews" className="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
          <svg className="mr-3 h-5 w-5 text-gray-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  const headerContent = (
    <>
      <h2 className="text-lg font-semibold text-gray-200 hidden sm:block truncate mr-4">Platform Operations</h2>
